                    ...
                    <div className="card-body">
                      <div className="template-box-2">
                        ...
                        <div className="genre-section">
                          <Button variant="contained" className="genre-button">Rock</Button>
                          <Button variant="contained" className="genre-button">OPM</Button>
                          <Button variant="contained" className="genre-button">HipHop</Button>
                          <Button variant="contained" className="genre-button">Rap</Button>
                          <Button variant="contained" className="genre-button">Country</Button>
                          <Button variant="contained" className="genre-button">Classic</Button>
                        </div>
                      </div>
                    </div>
                  </div>
